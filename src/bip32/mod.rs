...
pub use extended_key::{
    attrs::ExtendedKeyAttrs, extended_private_key::ExtendedPrivateKey, extended_public_key::ExtendedPublicKey,
    ExtendedKey,
};
pub use {
    extended_key::{extended_private_key::XPrv, extended_public_key::XPub}
};
